namespace Gradebook.Web.Services
{
    ...
    public class FileManagementService : IFileManagementService
    {
        ...
        public void DeleteImage(string imageFolderName, string imageName)
        {
            var galleryFolder = Path.Combine(_webHostEnvironment.WebRootPath, @$"images\{imageFolderName}");
            ...
            {
                throw new InvalidOperationException($@"Image not found {imageFolderName}\{imageName}");
            }
        }
    }
}